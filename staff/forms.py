...
class ContentForm(VerticalMixin, forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "linked": autocomplete.ModelSelect2Multiple(
...
class UserManageForm(VerticalMixin, forms.ModelForm):
    ...
    def is_valid(self):
        ...
        if (
            self.cleaned_data["new_password"] or self.cleaned_data["confirm_password"]
        ) and self.cleaned_data["new_password"] != self.cleaned_data[
            "confirm_password"
        ]:
