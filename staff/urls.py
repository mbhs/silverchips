...
create_urlpatterns = (
    [
        ...
        path("art/", views.ArtCreateView.as_view(), name="art"),
...
content_urlpatterns = (
    [
        ...
        path(
            "<int:pk>/set-visibility/<int:level>/",
            views.set_content_visibility,
            name="set_visibility",
        ),
...
comment_urlpatterns = (
    [
        ...
        path(
            "<int:pk>/set-approval/<int:level>/",
            views.set_comment_approval,
            name="set_approval",
        ),
...
autocomplete_urlpatterns = (
    [
        ...
        path(
            "tags/",
            autocomplete.TagAutocomplete.as_view(create_field="name"),
            name="tags",
        ),
        ...
        path("art/", autocomplete.ArtAutocomplete.as_view(), name="art"),
